...
<head>
	...
	?>
	<title>PintaDukit | Product Sold</title>
</head>
...
<body>
	...
	<section id="content">
		...
		<main>
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3><i class='bx bxs-cart'></i>Product Sold List</h3>
					</div>
					<!-- BODY -->
	...
	<script>
		...
		function setSessionValues(eventId) {
			fetch('product-sold-details.php', {
					method: 'POST',
					headers: {
				...
				.then(response => {
					window.location.href = 'product-sold-details';
				})
				.catch(error => {
