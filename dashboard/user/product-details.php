                        ...
                        <?php if ($product_data['status'] == 'active') { ?>
                            <div class="action">
                                ...
                                if ($product_data['bidding_status'] == "open") { ?>
                                    <button type="button" class="btn btn-warning"><a href="controller/product-controller?id=<?php echo $product_data['id'] ?>&close_bidding_product=1" class="close"><i class='bx bx-window-close'></i> Close Bidding</button>

                                <?php
                                } else if ($product_data['bidding_status'] == "closed") { ?>
                                    <button type="button" class="btn btn-success"><a href="controller/product-controller?id=<?php echo $product_data['id'] ?>&open_bidding_product=1" class="open"><i class='bx bxs-lock-open-alt'></i> Open Bidding</button>
                    ...
                    <section class="data-table">
                        <div class="info-data">
                            ...
                            ?>
                                ...
                                ?>
                                <div class="bidd-button">
                                    <button type="button" class="btn btn-primary"><a href="controller/product-controller?product_id=<?php echo $product_data['id'] ?>&select_bidding_winner=1" class="winner"> Auto-Select Winner</button>
                                </div>
                            <?php
                            } else {
                            ?>
