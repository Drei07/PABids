    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    <div class="head">
                        <h3><i class='bx bxs-graduation'></i> List of My Favorite</h3>
                    </div>
                    <!-- BODY -->
                    <section class="data-table">
                        ...
                        <ul class="box-info" id="product">
                            <?php
                            $stmt = $user->runQuery("SELECT * FROM favorite WHERE user_id=:user_id AND status = :status");
                            $stmt->execute(array(":user_id" => $user_id, ":status" => "active"));

                            // Check if there are favorite entries
                            if ($stmt->rowCount() >= 1) {
                                while ($favorite_data = $stmt->fetch(PDO::FETCH_ASSOC)) {
