...
if(isset($_POST['btn-forgot-password']))
{
 ...
 $stmt->execute(array(":email"=>$email, ":user_type" => 2));
 ...
 if($stmt->rowCount() == 1)
 {
  ...
  <body>
      ...
      <img src='cid:logo' alt='Logo' width='150'>
          ...
          <p><a class='button' href='$main_url/dashboard/user/authentication/user-reset-password?id=$id&code=$code'>Reset Password</a></p>
