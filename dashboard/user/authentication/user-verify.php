 ...
 if($stmt->rowCount() > 0)
 {
  if($row['status']==$status_N)
  {
   ...
   $msg = "
        ...
        <a href='signin' style='text-decoration:none; display: flex; justify-content: right; font-size: 1.2rem; color:#000000; font-weight:600;''>Signin here  <img src='src/img/caret-right-fill.svg' style='margin-top: .5rem; margin-left: 5px;' width='15' height='15' alt='Arrow right'></a>";
  }
  else
  {
   $msg = "
