...
<head>
	...
	?>
	<title>PintaDukit | Product Archive</title>
</head>
	...
	<section id="content">
		...
		<main>
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3><i class='bx bxs-cart'></i>Archive Product List</h3>
					</div>
					<!-- BODY -->
					<section class="data-table">
						...
						<ul class="box-info" id="product">
							<?php
							$stmt = $user->runQuery("SELECT * FROM product WHERE user_id=:user_id  AND status = :status ORDER BY id DESC");
							$stmt->execute(array(":user_id" => $user_id, ":status" => "disabled"));
