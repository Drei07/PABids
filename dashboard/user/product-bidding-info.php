...
<head>
    ...
    ?>
    <title>PintaDukit | Product Bidding Details</title>
</head>
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>|</li>
                        <li>
                            <a class="active" href="bids">Bids</a>
                        </li>
                        <li>|</li>
                        <li>
                            <a href="">Product Bidding Data</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <li class="slideshow-item" data-images="<?php echo implode(',', $image_filenames); ?>">
                    ...
                    <div class="details">
                        ...
                        <div class="action">
                            ...
                            ?>
                           <p><strong>Bidding Status:</strong>
                            <?php
                            if($bidding_data['status'] == "active"){
                                    if ($bidding_data['bid_status'] == "pending") {
                                        echo "PENDING";
                                    } elseif ($bidding_data['bid_status'] == "lost") {
                                        echo "LOST";
                                    } elseif ($bidding_data['bid_status'] == "winner") {
                                        echo "WINNER";
                                    } else {
                                        echo "Unknown"; // Provide a default value for unknown statuses
                                    }
                            }else{
                                echo "CANCELED";
                            }
                            ...
                            <?php
                                if($bidding_data['status'] == "active" && $bidding_data['bid_status'] == "pending" && $product_data['bidding_status'] == "open"){
                            ?>
                                <button type="button" class="btn btn-danger"><a href="controller/product-controller?id=<?php echo $bidding_data['id'] ?>&cancel_bid=1" class="cancel"><i class='bx bxs-x-circle' ></i> Cancel Bidd</a></button>
                            <?php
                                }else{
                            ?>
                            <?php
